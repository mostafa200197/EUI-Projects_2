...
typedef struct
{
    ...
    volatile uint32_t RESERVED2[678]; /* RESERVED 2 */
...
#define GPIOA_AHB                       ((GPIO_RegDef_t*) GPIOA_AHB_BASE_ADDRESS)
#define GPIOB_AHB                       ((GPIO_RegDef_t*) GPIOB_AHB_BASE_ADDRESS)
#define GPIOC_AHB                       ((GPIO_RegDef_t*) GPIOC_AHB_BASE_ADDRESS)
#define GPIOD_AHB                       ((GPIO_RegDef_t*) GPIOD_AHB_BASE_ADDRESS)
#define GPIOE_AHB                       ((GPIO_RegDef_t*) GPIOE_AHB_BASE_ADDRESS)
#define GPIOF_AHB                       ((GPIO_RegDef_t*) GPIOF_AHB_BASE_ADDRESS)
...
/**********************************************************************************************************************
 *  Analog Comparator Base Definition
 *********************************************************************************************************************/
#define COMP_BASE_ADDRESS               0x4003C000UL

/**********************************************************************************************************************
 *  Analog Comparator Register Definition
 *********************************************************************************************************************/

typedef struct
{
    volatile uint32_t ACMIS; /* Analog Comparator Masked Interrupt Status */
    volatile uint32_t ACRIS; /* Analog Comparator Raw Interrupt Status */
    volatile uint32_t ACINTEN; /* Analog Comparator Interrupt Enable */
    volatile uint32_t RESERVED; /* RESERVED 1 */
    volatile uint32_t ACREFCTL; /* Analog Comparator Reference Voltage Control */
    volatile uint32_t RESERVED2[3]; /* RESERVED 2 */
    volatile uint32_t ACSTAT0; /* Analog Comparator Status 0 */
    volatile uint32_t ACCTL0; /* Analog Comparator Control 0 */
    volatile uint32_t RESERVED3[6]; /* RESERVED 3 */
    volatile uint32_t ACSTAT1; /* Analog Comparator Status 1 */
    volatile uint32_t ACCTL1; /* Analog Comparator Control 1 */
    volatile uint32_t RESERVED4[990]; /* RESERVED 4 */
    volatile uint32_t PP; /* Analog Comparator Peripheral Properties */
} COMP_RegDef_t;

#define COMP                            ((COMP_RegDef_t*) COMP_BASE_ADDRESS)
