...
includes
******************************************************************************/
#include "MCAL/register_map_adham.h"
#include "Bit_Math.h"
...
function prototypes
******************************************************************************/
void DMA_init(uint32_t *source,uint32_t *destination,uint32_t channel);
uDMA_Channel_Control_Structure_RegDef_t control_table[30] __attribute__((aligned(1024)));
void DMA_start_transfere(uint32_t channel_number,uint32_t modes,uint32_t items_number);
